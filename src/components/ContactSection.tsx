const ContactSection = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'GitHub',
      value: 'github.com/adameshodelin',
      href: 'https://github.com/adameshodelin'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Whether you have a project in mind, a job opportunity, or just want to chat about technology, 
          ...
          <div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              <div className="mb-6">
                <svg className="w-16 h-16 text-primary-600 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <a 
                href="/Adames_Hodelin_Resume_Junction.pdf"
                download
